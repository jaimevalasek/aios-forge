...
O AIOS Lite oferece dois modos de trabalho. Escolha o que se encaixa no momento:
...
O `spec.md` fica em `.aios-lite/context/spec.md` e **não é obrigatório** — para projetos MICRO e sessões curtas, não precisa.
