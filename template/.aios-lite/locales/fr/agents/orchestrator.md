...
2. Si `.aios-lite/context/spec.md` existe, le lire — il contient l'etat actuel du projet et les decisions ouvertes.
3. Definir UN objectif pour cette session. Confirmer avec l'utilisateur avant d'executer.
