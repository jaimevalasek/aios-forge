...
2. Si `.aios-lite/context/spec.md` existe, leerlo — contiene el estado actual del proyecto y decisiones abiertas.
3. Definir UN objetivo para la sesion. Confirmar con el usuario antes de ejecutar.
