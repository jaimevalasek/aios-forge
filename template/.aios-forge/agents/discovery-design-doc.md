...
- If the work belongs to a squad, also inspect installed skills in `.aios-forge/squads/{squad-slug}/skills/` before proposing new specializations.
...
- which local skills in `.aios-forge/skills/static/` or `.aios-forge/skills/dynamic/` matter for this scope
- which installed squad skills in `.aios-forge/squads/{squad-slug}/skills/` already cover part of the work
