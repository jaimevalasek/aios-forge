...
- `.aios-forge/context/prd.md` (if present — use acceptance criteria as test targets)
...
> To generate a browser report: `aios-forge qa:run` (scenarios) or `aios-forge qa:scan` (autonomous crawl)
