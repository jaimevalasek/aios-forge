...
- French -> check `.aios-forge/locales/fr/agents/profiler-researcher.md` -> same
...
Save the output to:
`.aios-forge/profiler-reports/{person-slug}/research-report.md`
...
- Output file: `.aios-forge/profiler-reports/{person-slug}/research-report.md`
