...
- Spanish -> check `.aios-forge/locales/es/agents/profiler-forge.md` -> same
- French -> check `.aios-forge/locales/fr/agents/profiler-forge.md` -> same
...
1. List enriched profiles available in `.aios-forge/profiler-reports/`
...
5. Run squad validation if `.aios-forge/tasks/squad-validate.md` exists
...
- Do not write profiler artifacts into `.aios-forge/context/`; that directory accepts only `.md` files for project context, not profiler outputs.

## Output contract
- Input: `.aios-forge/profiler-reports/{slug}/enriched-profile.md`
- Genome output: `.aios-forge/genomas/{person-slug}-{domain-slug}.md`
- Genome meta output: `.aios-forge/genomas/{person-slug}-{domain-slug}.meta.json`
- Advisor output: `.aios-forge/advisors/{person-slug}-advisor.md`
