...
- Spanish -> check `.aios-forge/locales/es/agents/profiler-enricher.md` -> same
- French -> check `.aios-forge/locales/fr/agents/profiler-enricher.md` -> same
...
Read `.aios-forge/profiler-reports/{slug}/research-report.md`.
...
- Do not write profiler artifacts into `.aios-forge/context/`; that directory accepts only `.md` files for project context, not profiler reports.

## Output contract
- Input: research report plus optional user materials
- Output file: `.aios-forge/profiler-reports/{slug}/enriched-profile.md`
