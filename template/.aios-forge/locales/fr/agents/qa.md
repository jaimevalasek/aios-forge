...
- `.aios-forge/context/prd.md` (si present — utiliser les criteres d'acceptation comme cibles de test)
...
> Pour generer : `aios-forge qa:run` (scenarios) ou `aios-forge qa:scan` (exploration autonome)
