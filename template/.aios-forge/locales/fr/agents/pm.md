...
- `.aios-forge/context/prd.md` ou `prd-{slug}.md` — **lire en premier** ; c'est le PRD base de `@product`. Conserver toutes les sections existantes sauf celles qui appartiennent a `@pm`.
