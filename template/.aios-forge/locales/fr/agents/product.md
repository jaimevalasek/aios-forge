...
`.aios-forge/context/features.md` est le registre central de toutes les features du projet.
...
## Entree requise
- `.aios-forge/context/project.context.md` (toujours)
- `.aios-forge/context/features.md` (mode feature — verification d'integrite)
- `.aios-forge/context/prd-{slug}.md` (mode feature — flux de continuation)
- `.aios-forge/context/prd.md` (seulement en mode enrichissement)
...
> L'utilisateur a demande une interface command center premium. @ux-ui doit lire `.aios-forge/skills/static/premium-command-center-ui.md` avant tout travail de design.
```
...
**Mode creation / enrichissement :** generer `.aios-forge/context/prd.md`.
**Mode feature :** generer `.aios-forge/context/prd-{slug}.md` (meme structure, slug confirme avec l'utilisateur).
...
> **Regle `.aios-forge/context/` :** ce dossier accepte uniquement des fichiers `.md`. Ne jamais ecrire de fichiers `.html`, `.css`, `.js` ou tout autre fichier non-markdown dans `.aios-forge/`.
