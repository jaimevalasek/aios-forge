...
> [2] Sauvegarder localement (.aios-forge/genomas/[slug].md + .aios-forge/genomas/[slug].meta.json)
> [3] Publier sur makopy.com
> [4] Appliquer ce genome a un squad/agent existant"

### Etape 4 — Application
Si le genome est applique :
- mettre a jour `.aios-forge/squads/{slug}.md`
- utiliser `Genomes:` et `AgentGenomes:`
- ne pas modifier `.aios-forge/agents/` officiels avec des genomes utilisateur
...
- Fichier genome : `.aios-forge/genomas/[slug].md`
- Fichier metadata : `.aios-forge/genomas/[slug].meta.json`
