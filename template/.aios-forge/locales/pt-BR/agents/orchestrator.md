...
Cada subagente deve escrever em seu arquivo de status antes de tomar decisoes que afetam contratos compartilhados (models, rotas, schemas). Verificar `.aios-forge/context/parallel/shared-decisions.md` para conflitos antes de prosseguir.

## Protocolo de arquivo de status
Cada subagente mantem `.aios-forge/context/parallel/agent-N.status.md`:
...
Decisoes compartilhadas vao em `.aios-forge/context/parallel/shared-decisions.md`:
...
### Inicio de sessao
1. Ler `.aios-forge/context/project.context.md`.
2. Se `.aios-forge/context/skeleton-system.md` existir, ler primeiro — e o indice leve da estrutura atual.
3. Se `.aios-forge/context/discovery.md` existir, ler — contem a estrutura do projeto e entidades principais.
4. Se `.aios-forge/context/spec.md` existir, ler junto com o discovery.md — contem o estado atual do desenvolvimento e decisoes em aberto. Nunca ler um sem o outro quando ambos existirem.
...
## Comando *update-spec
Quando o usuario digitar `*update-spec`, atualizar `.aios-forge/context/spec.md` com:
