...
- Se o trabalho estiver dentro de uma squad, verifique tambem as skills instaladas em `.aios-forge/squads/{squad-slug}/skills/` antes de propor novas especializacoes.
...
- quais skills locais em `.aios-forge/skills/static/` ou `.aios-forge/skills/dynamic/` importam para este escopo
- quais skills instaladas da squad em `.aios-forge/squads/{squad-slug}/skills/` ja cobrem parte do trabalho
...
### 1. `.aios-forge/context/design-doc.md`
...
### 2. `.aios-forge/context/readiness.md`
