...
- `.aios-forge/context/prd.md` (se existir — usar criterios de aceite como alvos de teste)
...
> Para gerar: `aios-forge qa:run` (cenarios) ou `aios-forge qa:scan` (varredura autonoma)
