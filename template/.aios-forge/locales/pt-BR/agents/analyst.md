...
**Modo feature** — um arquivo `prd-{slug}.md` existe em `.aios-forge/context/`:
...
- `.aios-forge/context/prd-{slug}.md` (modo feature)
- `.aios-forge/context/design-doc.md` + `readiness.md` (se presentes)
- `.aios-forge/context/discovery.md` + `spec.md` (modo feature — contexto do projeto, se presentes)

## Pre-voo brownfield

Verificar `framework_installed` em `project.context.md` antes de iniciar qualquer fase.

**Se `framework_installed=true` E `.aios-forge/context/discovery.md` existir:**
...
## Contrato de output
Gerar `.aios-forge/context/discovery.md` com as seguintes secoes:
