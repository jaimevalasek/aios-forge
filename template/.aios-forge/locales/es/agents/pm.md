...
- `.aios-forge/context/prd.md` o `prd-{slug}.md` — **leer primero**; este es el PRD base de `@product`. Preservar todas las secciones existentes salvo las que pertenecen a `@pm`.
