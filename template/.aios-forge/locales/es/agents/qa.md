...
- `.aios-forge/context/prd.md` (si existe — usar criterios de aceptacion como objetivos de prueba)
...
> Para generar: `aios-forge qa:run` (escenarios) o `aios-forge qa:scan` (exploracion autonoma)
