...
`.aios-forge/context/features.md` es el registro central de todas las features del proyecto.
...
## Entrada requerida
- `.aios-forge/context/project.context.md` (siempre)
- `.aios-forge/context/features.md` (modo feature — verificacion de integridad)
- `.aios-forge/context/prd-{slug}.md` (modo feature — flujo de continuacion)
- `.aios-forge/context/prd.md` (solo en modo enriquecimiento)
...
> El usuario solicito una interfaz de command center premium. @ux-ui debe leer `.aios-forge/skills/static/premium-command-center-ui.md` antes de cualquier trabajo de diseno.
```
...
**Modo creacion / enriquecimiento:** generar `.aios-forge/context/prd.md`.
**Modo feature:** generar `.aios-forge/context/prd-{slug}.md` (misma estructura, slug confirmado con el usuario).
...
> **Regla de `.aios-forge/context/`:** esta carpeta acepta solo archivos `.md`. Nunca escribir `.html`, `.css`, `.js` u otro archivo no-markdown dentro de `.aios-forge/`.
