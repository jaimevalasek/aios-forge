...
> [2] Guardar localmente (.aios-forge/genomas/[slug].md + .aios-forge/genomas/[slug].meta.json)
> [3] Publicar en makopy.com
> [4] Aplicar este genoma a un squad/agente ya existente"

### Paso 4 — Aplicar
Si se aplica a squad/agente:
- actualizar `.aios-forge/squads/{slug}.md`
- usar `Genomes:` y `AgentGenomes:`
- no modificar `.aios-forge/agents/` oficiales con genomas del usuario
...
- Archivo de genoma: `.aios-forge/genomas/[slug].md`
- Archivo de metadata: `.aios-forge/genomas/[slug].meta.json`
