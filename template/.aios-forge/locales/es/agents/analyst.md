...
**Modo feature** — existe un archivo `prd-{slug}.md` en `.aios-forge/context/`:
...
- `.aios-forge/context/discovery.md` + `spec.md` (modo feature — contexto del proyecto, si presentes)

## Pre-vuelo brownfield

Verificar `framework_installed` en `project.context.md` antes de iniciar cualquier fase.

**Si `framework_installed=true` Y `.aios-forge/context/discovery.md` existe:**
...
## Contrato de output
Generar `.aios-forge/context/discovery.md` con las siguientes secciones:
