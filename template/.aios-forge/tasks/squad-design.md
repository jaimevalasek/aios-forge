...
1. Procure `.aios-forge/squads/.artisan/<id>.md`
...
Verifique se existe `.aios-forge/templates/squads/`. Se existir, liste os templates disponíveis e pergunte:
...
Salve o blueprint em `.aios-forge/squads/.designs/<slug>.blueprint.json`
...
## Saída
- Arquivo: `.aios-forge/squads/.designs/<slug>.blueprint.json`
