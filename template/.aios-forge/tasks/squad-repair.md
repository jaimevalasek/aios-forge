...
Se o slug existe como diretório em `.aios-forge/squads/<slug>/` mas NÃO tem `squad.manifest.json`:
...
Ler e executar mentalmente `.aios-forge/tasks/squad-validate.md` após todas as correções para confirmar que o pacote está consistente.
