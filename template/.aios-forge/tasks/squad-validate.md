...
- Quando o CLI `aios-forge squad:validate <slug>` é executado

## Entrada
- slug do squad (deve existir em `.aios-forge/squads/<slug>/`)

## Processo

### Camada 1 — Validação de schema
1. Leia `.aios-forge/squads/<slug>/squad.manifest.json`
2. Valide contra `.aios-forge/schemas/squad-manifest.schema.json`
...
- `.aios-forge/squads/<slug>/squad.manifest.json` (obrigatório)
- `.aios-forge/squads/<slug>/agents/agents.md` (obrigatório)
- `.aios-forge/squads/<slug>/agents/orquestrador.md` (obrigatório)
