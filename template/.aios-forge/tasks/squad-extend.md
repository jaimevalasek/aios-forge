...
Changes to apply:
  ...
  NEW FILE: .aios-forge/squads/<slug>/agents/<executor>.md
  UPDATED: .aios-forge/squads/<slug>/squad.manifest.json
    + executors[]: { slug: "<executor>", role: "...", file: "..." }
  UPDATED: .aios-forge/squads/<slug>/agents/agents.md
    + @<executor> — <role>
  UPDATED: CLAUDE.md
    + /<executor> -> .aios-forge/squads/<slug>/agents/<executor>.md
  UPDATED: AGENTS.md
    + @<executor> -> .aios-forge/squads/<slug>/agents/<executor>.md
